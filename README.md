...
![](https://img.shields.io/badge/release-1.3.0-red.svg?style=flat)
...
buildscript {
    dependencies {
        classpath 'com.iqiyi.android.qigsaw:gradle-plugin:1.3.0'
    }
}
```
...
dependencies {
    //qigsaw core lib
    implementation "com.iqiyi.android.qigsaw:splitcore:1.3.0"
}
...
...
