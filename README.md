...
![](https://img.shields.io/badge/release-1.3.3.1-red.svg?style=flat)
...
buildscript {
    dependencies {
        classpath 'com.iqiyi.android.qigsaw:gradle-plugin:1.3.3.1'
    }
}
```
...
dependencies {
    //qigsaw core lib
    implementation "com.iqiyi.android.qigsaw:splitcore:1.3.3.1"
}
...
...
